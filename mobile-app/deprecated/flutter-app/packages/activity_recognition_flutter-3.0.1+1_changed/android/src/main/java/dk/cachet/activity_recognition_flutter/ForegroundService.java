...
public class ForegroundService extends Service {
    ...
    public ForegroundService() {
        super();
        android.util.Log.d(TAG, "ForegroundService");
    }
    ...
    private void startPluginForegroundService(Bundle extras) {
        android.util.Log.d(TAG, "startPluginForegroundService");
...
//        int icon = getResources().getIdentifier((String) extras.get("icon"), "drawable", context.getPackageName());
        ...
        Log.d("HECTOR", "tras hacer startForeground en startPluginForegroundService de ForegroundService.java");
    }
