...
class MethodChannelPermissionHandler extends PermissionHandlerPlatform {
  ...
  Future<Map<Permission, PermissionStatus>> requestPermissions(
    ...
    print("En requestPermissions de method_channel_permission_handler.dart");
    ...
    try {
      ...
      print(e);
      print("NO HAY ACTIVITY: DEVUELVO GRANTED!!!!");
      //print(stacktrace);
      final status = {for (var v in data) v: 1}; //1 = PermissionStatus.granted
      return Codec.decodePermissionRequestResult(Map<int, int>.from(status));
    }
  }
