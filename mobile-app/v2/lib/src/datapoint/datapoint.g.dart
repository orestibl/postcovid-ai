...
Data _$DataFromJson(Map<String, dynamic> json) => Data(
      ...
      datameasured: json['datameasured'] as String? ?? "",
    );

Map<String, dynamic> _$DataToJson(Data instance) => <String, dynamic>{
      'id': instance.id,
      'datameasured': instance.datameasured,
    };
...
DataPointHeader _$DataPointHeaderFromJson(Map<String, dynamic> json) => DataPointHeader(
      studyId: json['study_id'] as String?,
      userId: json['user_id'] as String?,
      dataFormat: json['data_format'] == null ? DataFormat.UNKNOWN : DataFormat.fromJson(json['data_format'] as Map<String, dynamic>),
...
Map<String, dynamic> _$DataFormatToJson(DataFormat instance) => <String, dynamic>{
