...
class TestSurvey implements Survey {
  String get title => "Test survey";

  String get description => "5 test questions";

  int get minutesToComplete => 1;

  static List<RPChoice> _choices = [
    RPChoice.withParams("Choice 1", 1),
    RPChoice.withParams("Choice 2", 2),
    RPChoice.withParams("Choice 3", 3),
  ];

  final RPChoiceAnswerFormat _choiceAnswerFormat =
      RPChoiceAnswerFormat.withParams(ChoiceAnswerStyle.SingleChoice, _choices);

  RPTask get survey => RPOrderedTask(title, [
        RPInstructionStep(title: title)..text = "This is the introduction",
        ...
        RPCompletionStep("completion_id")
          ..title = "This appears when survey finishes"
          ..text = "Thank you!",
      ]);
}
